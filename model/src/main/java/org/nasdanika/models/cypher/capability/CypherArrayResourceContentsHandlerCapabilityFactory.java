 ...
 */
public class CypherArrayResourceContentsHandlerCapabilityFactory extends ServiceCapabilityFactory<org.nasdanika.capability.emf.ResourceContentsHandler.Requirement, ResourceContentsHandler<EObject[]>> {
	...
	protected CompletionStage<Iterable<CapabilityProvider<ResourceContentsHandler<EObject[]>>>> createService(
		...
		return wrap(new CypherResourceContentsHandler().adaptToEObjectArrayContentsHandler());
	}
