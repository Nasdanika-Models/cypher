 ...
 */
public class CypherResourceContentsHandlerCapabilityFactory extends ServiceCapabilityFactory<org.nasdanika.capability.emf.ResourceContentsHandler.Requirement, ResourceContentsHandler<Document>> {
	...
	protected CompletionStage<Iterable<CapabilityProvider<ResourceContentsHandler<Document>>>> createService(
		...
		return wrap(new CypherResourceContentsHandler());
	}
